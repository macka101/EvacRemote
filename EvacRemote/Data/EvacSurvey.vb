...
Public Class FieldOption
    ...
    Public Sub New(ByVal session As Session)
        MyBase.New(session)
    End Sub
    Public Sub New(ByVal ID_renamed As Integer, ServiceField As eServiceFields, ByVal desc_Renamed As String)
        Me._iD = ID_renamed
        Me._serviceField = ServiceField
        Me._description = desc_Renamed
    End Sub
...
Public Class Asset
    ...
    Public Sub New(ByVal ID_Renamed As Integer, building_Renamed As Integer, ByVal barcode_Renamed As String, ByVal product_Renamed As String, ByVal installed_Renamed As Date, notes_Renamed As String)
        Me.ID_Renamed = ID_Renamed
        Me.building_Renamed = building_Renamed
        Me.barcode_Renamed = barcode_Renamed
        Me.product_Renamed = product_Renamed
        Me.installed_Renamed = installed_Renamed
        Me.notes_Renamed = notes_Renamed
    End Sub
    Private _ID As Integer
    <Persistent, Key(True)> _
    Public Property ID() As Integer
