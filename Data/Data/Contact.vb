...
Public Class Contact
    ...
    Public ReadOnly Property FullAddressBlock() As String
        Get
            ...
            Return GetFullAddressBlock(Address.Address1, Address.Address2, Address.Address3, Address.Address4, Address.PostCode)
        End Get
    End Property
    Public Function GetFullAddressLine() As String
        ...
        Return ret
    End Function
    Public Shared Function GetFullAddressBlock(ByVal Address1 As String, ByVal Address2 As String, ByVal Address3 As String, ByVal Address4 As String, ByVal PostCode As String) As String
        Dim ret As String = String.Empty

        If Address1 IsNot Nothing And Address1 IsNot String.Empty Then
            ret = String.Format("{0}", Address1)
        End If
        If Address2 IsNot Nothing And Address2 IsNot String.Empty Then
            ret = String.Format("{0}{1}{2}", ret, vbCrLf, Address2)
        End If
        If Address3 IsNot Nothing And Address3 IsNot String.Empty Then
            ret = String.Format("{0}{1}{2}", ret, vbCrLf, Address3)
        End If
        If Address4 IsNot Nothing And Address4 IsNot String.Empty Then
            ret = String.Format("{0}{1}{2}", ret, vbCrLf, Address4)
        End If
